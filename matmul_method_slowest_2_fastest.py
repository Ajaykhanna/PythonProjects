...
print('Method #1: Matrix Multiplication in Pure Python: \n',
       matmul(a_matrix, b_matrix), '\n')
print('Method #2: Using PyTorch Element-wise operation Method: \n',
       matmul_reduction(a_matrix, b_matrix), '\n')
print('Method #3: Using PyTorch Broadcast Method: \n',
       matmul_broadcasting(a_matrix, b_matrix), '\n')
print('Method #4: Using Einstein Method: \n',
       matmul_einstein(a_matrix, b_matrix),'\n')
print('Method #5: PyTorch MatMul Boosted by Assembly Language: \n',
