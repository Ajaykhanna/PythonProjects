...
print(
    "Matrix Multiplication with Standard Method: \n", matmul(a_matrix, b_matrix), "\n"
)
...
tic = time.perf_counter()
print(
    "Matrix Multiplication with Standard Strassen Method: \n",
...
tic = time.perf_counter()
print(
    "Matrix Multiplication with PyTorced Strassen Method \n",
...
tic = time.perf_counter()
print(
    "Matrix Multiplication with PyTorced MatMul Method \n",
